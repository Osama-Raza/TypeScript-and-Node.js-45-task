...
function makeTshirt(sizes, messages) {
...
function showMagician2(magiciansNames) {
...
let newCars = carInfo('Honda', 'Civic', ['Color', 'Red'], ['Feature', 'Sunroof']);
console.log(newCars);
